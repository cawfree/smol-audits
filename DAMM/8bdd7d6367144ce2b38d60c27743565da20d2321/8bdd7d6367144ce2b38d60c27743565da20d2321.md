...
> 
> Different hook implementations signalling the same position pointer results in the emergence of unintentional shared context between isolated hooks which subvert access control mechanisms.
>
> ### Description
> 
...
> ```
> 
> Consequently, it is possible for access control rules for a position to be violated, **since blacklisted assets from competing hook instances leak into different positions**, and **unapproved operators can influence the state of hooks they are explicitly unapproved for**.
> 
...
> ```
> 
> However, this solution is short sighted, since new permissionless hooks cannot be trusted to track positions accurately.
> 
